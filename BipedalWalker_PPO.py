...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=2e6, help="Total number of environment steps for training")
    ...
    parser.add_argument("--batch_size", type=int, default=2048, help="Number of collected samples per update (batch size)")
