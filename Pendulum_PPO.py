...
class main():
    def __init__(self , args):
        ...
        self.agent = Agent(args, env , [64,64]) # hidden layer size   
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=5e5, help="Set the number of steps used for training the agent")    
    ...
    parser.add_argument("--epochs", type=int, default=100, help="PPO training iteration parameter")
